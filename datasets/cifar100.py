...
class Cifar100(Dataset):
    def __init__(self, root_path, split="train", image_size=32, normalization=True, transform=None):
        ...
        if normalization:
            self.norm_params = {"mean": [0.5071, 0.4867, 0.4408], "std": [0.2675, 0.2565, 0.2761]}
        else:
...
class MetaCifar100(Cifar100):
    def __init__(
        ...
        super(MetaCifar100, self).__init__(root_path, split, image_size, normalization, transform)
