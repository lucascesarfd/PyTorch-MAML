...
__all__ = ["Module", "Conv2d", "Linear", "BatchNorm2d", "Sequential", "get_child_dict"]
    ...
    def forward(self, x, params=None, episode=None):
        ...
        if self.track_running_stats:
            ...
            if self.training:
                ...
                return F.batch_norm(
                    x, running_mean, running_var, weight, bias, True, exp_avg_factor, self.eps
                )
            else:
                if self.alpha:
                    ...
                    return F.batch_norm(
                        x, running_mean, running_var, weight, bias, False, 0.0, self.eps
                    )
        else:
