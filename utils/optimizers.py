...
def make(name, params, lr, weight_decay=0.0, schedule="step", milestones=None, gamma=0.1):
    """
...
def load(ckpt, params):
    train = ckpt["training"]
    optimizer, lr_scheduler = make(train["optimizer"], params, **train["optimizer_args"])
